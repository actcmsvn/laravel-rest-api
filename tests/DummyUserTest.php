...
use Actcmsvn\RestAPI\Tests\TestCase;
...
class DummyUserTest extends TestCase
{
    ...
    public function testUserIndexWithFilters()
    {
        ...
        $userId = $createFactory->of(\Actcmsvn\RestAPI\Tests\Models\DummyUser::class)->create();
    ...
    {
        $user = \Actcmsvn\RestAPI\Tests\Models\DummyUser::all()->random();
    ...
    public function testShowCommentsByUserRelationsEndpoint()
    {
        ...
        $post = \Actcmsvn\RestAPI\Tests\Models\DummyPost::all()->random();

        $createFactory = \Illuminate\Database\Eloquent\Factory::construct(\Faker\Factory::create(),
            base_path() . '/laravel-rest-api/tests/Factories');

        $comment = $createFactory->of(\Actcmsvn\RestAPI\Tests\Models\DummyComment::class)->create([
    ...
    public function testShowPostsByUserRelationsEndpoint()
    {
        ...
        $createFactory->of(\Actcmsvn\RestAPI\Tests\Models\DummyPost::class)->create([
            'post' => "dummy POst",
            'user_id' => $user->id,
        ]);
