...
namespace Actcmsvn\RestAPI\Routing;

use Closure;
use Actcmsvn\RestAPI\Exceptions\ApiException;
use Actcmsvn\RestAPI\Middleware\ApiMiddleware;
...
class ApiRouter extends Router
{
    ...
    {
        if ($this->container && $this->container->bound('Actcmsvn\RestAPI\Routing\ApiResourceRegistrar')) {
            $registrar = $this->container->make('Actcmsvn\RestAPI\Routing\ApiResourceRegistrar');
        }
        else {
